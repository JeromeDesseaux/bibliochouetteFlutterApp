...
class LoanUserPage extends StatelessWidget {
  ...
  LoanUserPage({Key key, @required this.user, @required this.book})
      : super(key: key);
        ...
        builder: (BuildContext context, AsyncSnapshot<DatabaseEvent> snapshot) {
          ...
          if (userCount == 0) {
            return new ListView(children: <Widget>[
              Text(
                  "Aucun utilisateur à qui prêter le livre. Veuillez d'abord en ajouter un.")
            ]);
          }
              ...
              return new ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => new LoanDatePage(
                          fuser: this.user, book: this.book, loanUser: user),
                    ),
                  );
                },
