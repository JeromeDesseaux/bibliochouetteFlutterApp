...
class UserDetailsPage extends StatelessWidget {
  ...
  UserDetailsPage({@required this.user, @required this.fuser, loans}) {
    try {
      List<Loan> returnedBooks =
          loans.where((test) => test.returnDateValidated != null).toList();
      List<Loan> loanedBooks =
          loans.where((test) => test.returnDateValidated == null).toList();
      loanedBooks
  ...
  void _edit(context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            new UserEditPage(fuser: this.fuser, user: this.user),
      ),
    );
  }
  ...
  String getFormattedText(Loan loan) {
    ...
    if (loan.returnDateValidated != null) {
      DateTime returnDate =
          new DateTime.fromMillisecondsSinceEpoch(loan.returnDateValidated);
      return "Rendu le " + formatter.format(returnDate);
    } else {
      DateTime returnDate =
          new DateTime.fromMillisecondsSinceEpoch(loan.expectedReturnDate);
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  new Text(
                    ...
                    style: new TextStyle(fontSize: 20.0, fontFamily: "Dekko"),
                  ),
                  new Container(
            ...
            new Expanded(
              ...
              itemBuilder: (context, int index) {
                ...
                return new ListTile(
                    ...
                    title: new Text(
                      loan.book.title,
                      style: new TextStyle(fontFamily: "Dekko"),
                    ),
                    subtitle: new Text(getFormattedText(loan)),
                    trailing: new Row(
                      ...
                      children: <Widget>[
                        new MyBullet(
                          isGreen:
                              loan.returnDateValidated == null ? false : true,
                        ),
                      ],
                    ));
              },
