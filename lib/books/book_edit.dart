...
class BookEditPage extends StatefulWidget {
  ...
  BookEditPage({Key key, @required this.book, @required this.uid}) : super(key: key);
...
class _BookEditPageState extends State<BookEditPage> {
  ...
  void _save(context) {
    // print(book.uid);
    // print(this.uid);
    FirebaseDatabase.instance.reference().child("books").child(this.uid).child(book.uid).update(book.toJson());
